...
const CreatePrompt = () => {
  ...
  // NEW: State for the live preview inputs
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/prompts', {
        ...
        body: JSON.stringify({ title, description, tags: tagsArray, content })
      });
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex gap-4">
                <button className="px-4 py-2 border border-vault-border rounded-md hover:bg-vault-card transition-colors flex items-center gap-2">
                  ...
                  <div className="bg-vault-card border border-vault-border rounded-xl p-6 mt-6">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button 
                        ...
                        className="text-vault-textMain text-sm font-medium flex items-center gap-2 border border-vault-border px-3 py-1.5 rounded hover:bg-vault-bg transition-colors"
                      >
                    ...
                    <div className="bg-vault-bg border border-vault-border rounded-lg p-4 min-h-[200px] whitespace-pre-wrap font-sans text-sm leading-relaxed text-vault-textMain">
                      {compiledText}
                    </div>
                  </div>
                )}
